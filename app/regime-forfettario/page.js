...
<div className="perc r">
            ...
            <div className="perc-steps">
              <a href="https://www.agenziaentrate.gov.it/portale/web/guest/schede/agevolazioni/regime-forfetario" target="_blank" rel="noopener noreferrer" className="ps">🏛 Agenzia Entrate — Forfettario</a>
              <a href="https://www.inps.it/it/it/dettaglio-scheda.schede-servizio-strumento.schede-servizi.iscrizione-alla-gestione-artigiani-e-commercianti-50498.iscrizione-alla-gestione-artigiani-e-commercianti.html" target="_blank" rel="noopener noreferrer" className="ps">📋 INPS — Contributi</a>
