          ...
          {variant === 'home' && (
            <>
              ...
              <div className="nav-links">
                <a href="https://www.facebook.com/groups/www.zeroburocrazia.it" target="_blank" rel="noopener noreferrer" className="nav-fb" aria-label="Gruppo Facebook" title="Entra nel gruppo">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.02 2 10.86c0 2.75 1.36 5.21 3.5 6.82V22l3.77-2.07c1.05.29 2.17.45 3.33.45h.4c5.52 0 10-4.02 10-8.86h-.4C22.4 6.02 17.52 2 12 2zm1.09 11.93l-2.54-2.72L5.18 14l5.89-6.25 2.6 2.72L18.93 8l-5.84 5.93z"/></svg>
                </a>
                <a href="https://www.facebook.com/profile.php?id=61584999492615" target="_blank" rel="noopener noreferrer" className="nav-fb" aria-label="Pagina Facebook" title="Segui la pagina">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.99 3.66 9.12 8.44 9.88v-6.99H7.9V12h2.54V9.8c0-2.5 1.49-3.89 3.78-3.89 1.09 0 2.24.2 2.24.2v2.46h-1.26c-1.24 0-1.63.77-1.63 1.56V12h2.78l-.44 2.89h-2.34v6.99C18.34 21.12 22 16.99 22 12z"/></svg>
                </a>
